...
{
    /// <inheritdoc />
<<<<<<<< HEAD:MadrasahManagement/Migrations/20260106133022_Mee.cs
    public partial class Mee : Migration
========
    public partial class seatplans : Migration
>>>>>>>> 6bc206f85af4d307e527d4399b86817a251da9f7:MadrasahManagement/Migrations/20260106035559_seatplans.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MadrasahId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibleToRoleId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notices_AspNetRoles_VisibleToRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssuedBooks_AspNetUsers_IssuedTo",
                        column: x => x.IssuedTo,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IncomeExpenseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExamId = table.Column<int>(type: "int", nullable: false),
                    TypesOfExpense = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                    ExamId = table.Column<int>(type: "int", nullable: false),
                    ExamAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamFees_Classes_ClassId1",
                        column: x => x.ClassId1,
                        principalTable: "Classes",
                        principalColumn: "ClassId");
                    table.ForeignKey(
                        name: "FK_ExamFees_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamRoutines_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PointConditions_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamFeeId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    ExamFeeAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalSubject = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamFeeCollections_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCGPA = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamResults_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatPlans_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeatPlans_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeatPlans_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "SubjectId",
                        onDelete: ReferentialAction.Restrict);
...
>>>>>>>> 6bc206f85af4d307e527d4399b86817a251da9f7:MadrasahManagement/Migrations/20260106035559_seatplans.cs
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamFeeCollections_ClassId",
                table: "ExamFeeCollections",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamFeeCollections_ExamFeeId",
                table: "ExamFeeCollections",
                column: "ExamFeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamFeeCollections_StudentId",
                table: "ExamFeeCollections",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamFees_ClassId1",
                table: "ExamFees",
                column: "ClassId1");

            migrationBuilder.CreateIndex(
                name: "IX_ExamFees_DepartmentId",
                table: "ExamFees",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_DepartmentId",
                table: "ExamResults",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamRoutines_DepartmentId",
                table: "ExamRoutines",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointConditions_DepartmentId",
                table: "PointConditions",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatPlans_ClassId",
                table: "SeatPlans",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatPlans_DepartmentId",
                table: "SeatPlans",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timetables_DepartmentId",
                table: "Timetables",
                column: "DepartmentId");
