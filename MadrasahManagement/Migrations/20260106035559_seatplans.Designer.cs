...
<<<<<<<< HEAD:MadrasahManagement/Migrations/20260106153936_Better.Designer.cs
    [Migration("20260106153936_Better")]
    partial class Better
========
    [Migration("20260106035559_seatplans")]
    partial class seatplans
>>>>>>>> 6bc206f85af4d307e527d4399b86817a251da9f7:MadrasahManagement/Migrations/20260106035559_seatplans.Designer.cs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MadrasahManagement.Models.ExamIncomeExpense", b =>
                {
                    ...
                    b.Property<string>("TypesOfExpense")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MadrasahManagement.Models.PointConditionDetail", b =>
                {
                    b.Property<int>("PointConditionDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PointConditionDetailId"));

                    b.Property<string>("Division")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("FromMark")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ToMark")
                        .HasColumnType("int");

                    b.HasKey("PointConditionDetailId");
...
>>>>>>>> 6bc206f85af4d307e527d4399b86817a251da9f7:MadrasahManagement/Migrations/20260106035559_seatplans.Designer.cs
            ...
            modelBuilder.Entity("MadrasahManagement.Models.ExamFeeCollection", b =>
                {
                    ...
                    b.HasOne("MadrasahManagement.Models.Subject", null)
                        .WithMany("ExamFeeCollections")
                        .HasForeignKey("SubjectId");
            ...
            modelBuilder.Entity("MadrasahManagement.Models.Expense", b =>
                {
                    b.HasOne("MadrasahManagement.Models.Salary", "Salary")
                        .WithMany()
            ...
            modelBuilder.Entity("MadrasahManagement.Models.PointConditionDetail", b =>
                {
                    b.HasOne("MadrasahManagement.Models.PointCondition", "PointCondition")
                        .WithMany("Details")
                        .HasForeignKey("PointConditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
